...
Task that you are required to complete, read this task description above carefully and never misunderstand the task.
{task_description}

The room you're in right now: {current_room}, remember this please.
